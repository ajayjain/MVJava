...
public class Pacman {
	private byte[][][] board;	// Holds counts of cheese and monsters at each spot on a 10 by 10 board
	private byte[] pacman;			// Data about pacman: [row, col, mouthAngle]
	private boolean isOpeningMouth, isDead, isWinner;	// booleans tracking state of pacman
	private Timer monsterTimer, pacmanTimer;	// Hold the timers for the game
	private byte cheese;	// Counts how much cheese is on the board
	private Font endFont;

	public GamePanel panel;	// JPanel containing all the content
	...
	private void placeStuff(int statusIndex) {
	...
	class GamePanel extends JPanel implements KeyListener {
		...
		public void drawBackground(Graphics g) {
			...
			g.drawString("Directions: a = left, d = right, w = up, s = down", 55, 485);
		}
